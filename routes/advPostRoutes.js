...
const { createAdvertisedPost,likeAdvertisedPost,replyToComment,addComment,getCommunitiesByCities,getCommunitiesByStates,likeCommentOrReply,addNestedReply,getCommunities,verifyPayment,getAdvertisedPosts,getUserAdvertisedPosts} = require("../controllers/advertisedPost");
...
router.get("/myads",auth,getUserAdvertisedPosts);
